...
background = pygame.transform.scale(pygame.image.load('sprites/background.png'),(frame_size_x, frame_size_y)).convert()
...
green_ship_img = pygame.transform.rotate(pygame.image.load('sprites/shipGreen.png'), 270)
blue_ship_img = pygame.transform.rotate(pygame.image.load('sprites/shipBlue.png'), 90)
...
def main():
    ...
    green_rect = pygame.Rect(800, 100, ship_width, ship_height)
    blue_rect = pygame.Rect(100, 100, ship_width, ship_height)
...
def welcome_screen():
    while True:
        ...
        welcome_text = welcome_font.render("Press any key to beign...", 1, white)
